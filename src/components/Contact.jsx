    ...
    <div className="flex text-center justify-center bg-blue-dark text-white py-12">
      <div className="flex flex-col gap-12 items-center w-full">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-16 w-56 md:w-[80%]">
          <ButtonWithIcon btnText="Get Free Quote" icon={<FaArrowRight />} classNames="bg-orange border-0 text-lg rounded-lg text-blue py-2 font-semibold px-8" />
          <ButtonWithIcon btnText="+1(555) 6823382" classNames="bg-orange border-0 text-lg rounded-lg text-white py-2 font-semibold px-8" />
        </div>
