...
const WhyChooseUs = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row">
        <div className="relative flex flex-col bg-pink p-[8%] w-full md:w-1/2 gap-8">
        <div className="absolute hidden md:block top-0 -end-32"><CurveArrow /></div>
            <h1 className="text-4xl text-blue font-semibold tracking-wider w-full md:w-8/12">Why Choose RTF Insurance?</h1>
        ...
        <div className="flex justify-center items-center p-8 md:p-20 w-full md:w-1/2">
